...
public class MypageController {
    ...
    public ResponseDto<?> getMyArticles(@AuthenticationPrincipal UserDetailsImpl userDetailsImpl) {
        return mypageService.getMyArticles(userDetailsImpl);
    }

    @RequestMapping(value = "/api/auth/mypage/myheart", method = RequestMethod.GET)
    public ResponseDto<?> getMyHeartArticles(@AuthenticationPrincipal UserDetailsImpl userDetailsImpl) {
